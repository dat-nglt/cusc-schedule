...
import {
    ...
    getSemesterCreateScheduleController,
...
/**
 * @route GET /api/semesters/getSemesterCreateSchedule
 * @desc Lấy danh sách học kỳ để tạo thời khóa biểu.
 * Yêu cầu quyền admin hoặc training_officer.
 * @access Private
 * */
semesterRoutes.get(
    '/getSemesterCreateSchedule',
    authenticateAndAuthorize(["admin", "training_officer"]),
    getSemesterCreateScheduleController
);
