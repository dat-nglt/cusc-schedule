...
create table users (
	user_id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,-- Mã định danh người dùng
	name VARCHAR(50),                                -- Họ và tên
	email VARCHAR(70) UNIQUE,                        -- Địa chỉ email (duy nhất)
	phone_number VARCHAR(20),                        -- Số điện thoại liên lạc
	password VARCHAR(1000),                  -- Mật khẩu (đã mã hóa)
...
CREATE TABLE lecturers (
    lecturer_id VARCHAR(50) NOT NULL PRIMARY KEY,       -- Mã giảng viên (ví dụ: GV001)
...
CREATE TABLE students (
    student_id VARCHAR(50) NOT NULL PRIMARY KEY,        -- Mã sinh viên (ví dụ: SV2023001)
