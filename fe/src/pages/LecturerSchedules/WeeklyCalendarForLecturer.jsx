...
// Main Component
const WeeklyCalendarForLecturer = ({
            ...
            <Box sx={{
                ...
                <Typography variant="h6" fontWeight="bold" sx={{ fontSize: { xs: '1rem', sm: '1.25rem' } }}>
                    {isMobile ? (
                        ...
                        `Lịch giảng dạy tuần ${currentDate ? format(currentDate, 'dd/MM/yyyy') : ''} - ${currentDate ? format(addDays(currentDate, 6), 'dd/MM/yyyy') : ''}`
                    )}
                </Typography>
...
export default WeeklyCalendarForLecturer;
